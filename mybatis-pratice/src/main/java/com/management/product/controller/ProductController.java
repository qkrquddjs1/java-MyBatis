...
public class ProductController {
    ...
    public void registNewProduct(ProductDTO product) {
        ...
        ProductDTO.setOrignCost(product.getCategoryCode());
      //  ProductDTO.setProductIonStatus(product.getOriginCost());
        ProductDTO.setProductIonStatus(product.getReleaseDate());
        ProductDTO.setProductIonStatus(product.getStockQuantity());
        ProductDTO.setProductIonStatus(product.getDiscountRate());


        if (productService.registNewProduct(ProductDTO)){
